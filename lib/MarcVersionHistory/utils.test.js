...
describe('transformVersion', () => {
  it('should return versions list in a format that AuditLogPane accepts', () => {
    ...
    expect(transformVersion(marcAuditVersion, formatMessageMock)).toEqual(expect.objectContaining(expectedVersion));
  });
});
