...
export const getActionLabel = formatMessage => {
  return {
    ADDED: formatMessage({ id: 'stripes-marc-components.versionHistory.action.added' }),
    MODIFIED: formatMessage({ id: 'stripes-marc-components.versionHistory.action.edited' }),
    REMOVED: formatMessage({ id: 'stripes-marc-components.versionHistory.action.removed' }),
  };
};
